...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        entertainmentRV.addItemDecoration(dividerItemDecoration);
        entertainmentRV.setLayoutManager(linearLayoutManager);
    ...
    /**
     * Method to make entertainment web service call
     */
    private void prepareNewsReaderCall() {
        Call<RootResponse> call = newsReaderAPI.loadEntertainmentNews();
